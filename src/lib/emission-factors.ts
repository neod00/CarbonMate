...
export const ELECTRICITY_EMISSION_FACTORS: ElectricityEmissionFactor[] = [
    // 한국 전력 그리드
    {
        id: 'electricity_korea_grid_2023',
        name: 'Korea National Grid 2023',
        nameKo: '한국 전력 그리드 (2023)',
        value: 0.4594,
        unit: 'kgCO2e/kWh',
        sourceType: 'fossil',
        source: '환경부 국가 LCI DB',
        year: 2023,
    ...
    {
        id: 'electricity_korea_grid_2022',
        name: 'Korea National Grid 2022',
        nameKo: '한국 전력 그리드 (2022)',
        value: 0.4663,
        unit: 'kgCO2e/kWh',
        sourceType: 'fossil',
        source: '환경부 국가 LCI DB',
    ...
    {
        id: 'electricity_korea_grid_2020',
        name: 'Korea National Grid 2020',
        nameKo: '한국 전력 그리드 (2020)',
        value: 0.478,
        unit: 'kgCO2e/kWh',
        sourceType: 'fossil',
        source: '환경부',
...
export const getDefaultElectricityFactor = (): ElectricityEmissionFactor => {
    return ELECTRICITY_EMISSION_FACTORS.find(f => f.id === 'electricity_korea_grid_2023') 
