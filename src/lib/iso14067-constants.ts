...
export const GHG_LIST = [
    { formula: 'CO2', name: '이산화탄소', gwp100_ar6: 1 },
    { formula: 'CH4', name: '메탄', gwp100_ar6: 29.8 },  // fossil: 29.8, biogenic: 27.0
    { formula: 'N2O', name: '아산화질소', gwp100_ar6: 273 },
    { formula: 'HFCs', name: '수소불화탄소', gwp100_ar6: 'varies' },
    { formula: 'PFCs', name: '과불화탄소', gwp100_ar6: 'varies' },
    { formula: 'SF6', name: '육불화황', gwp100_ar6: 25200 },
    { formula: 'NF3', name: '삼불화질소', gwp100_ar6: 17400 },
]
